...
export default function VenueMap() {
  ...
  // Google Maps URL for Beau Jardin, Giza
  const googleMapsUrl = "https://maps.app.goo.gl/zCGuiQsWyFDo9iME6?g_st=ic"
        ...
        <div className="relative group">
          ...
          <div className="relative w-full aspect-video min-h-[250px] rounded-2xl overflow-hidden border-2 border-accent/20 shadow-2xl transition-all duration-300 transform hover:scale-[1.02] cursor-pointer bg-slate-50">
            ...
            <div 
              ...
              role="button"
              tabIndex={0}
              aria-label="Open Beau Jardin location in Google Maps"
              onKeyDown={(e) => {
            ...
            >
              ...
              <Image
                src={staticMapUrl}
                alt="Beau Jardin Location - Click to open in Google Maps"
                fill
